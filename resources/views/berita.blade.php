...
<head>
	...
	<meta property="og:description"
		content='Aplikasi sederhana hasil iseng-iseng berhadiah Penampil Berita Kalteng yang berhasil si-crawl oleh Kofax Kapow yang update setiap hari 😁' />
	...
	<main class="container">
		<div class="row">
			<div class="col-12 col-lg-6 my-auto searchPanel">
				...
				<input type="text" name="searchKey" class="form-control form-control-lg" id="searchKey"
